      ...
      <div className="section-container py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="md:col-span-1 flex flex-col items-start md:items-center text-left md:text-center">
            <a href="#" className="flex items-left md:items-center justify-start md:justify-center gap-3 mb-4">
              <img src={veilLogo} alt="Veil" className="w-40 h-40 object-contain" />
          ...
          <div>
            <h4 className="font-semibold text-foreground mb-4 font-display">Community</h4>
            <ul className="space-y-3">
              {footerLinks.community.map((link) => {
                const IconComponent = link.icon;
                return (
                  <li key={link.label}>
                    <a href={link.href} className="text-sm text-muted-foreground hover:text-foreground transition-colors inline-flex items-center gap-1">
                      {link.label}
          ...
          <div>
            <h4 className="font-semibold text-foreground mb-4 font-display">Security</h4>
            <ul className="space-y-3">
