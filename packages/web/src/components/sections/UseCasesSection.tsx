import { Coins, Gift, Users, Code, Fingerprint, Building } from 'lucide-react';
import {
  Carousel,
  CarouselContent,
  CarouselItem,
...
const useCases = [
  {
    ...
    description: 'Claim airdrops without linking them to your main wallet. Keep your farming activity separate and private.',
  },
  {
    icon: Coins,
    title: 'Anonymous Payments',
    description: 'Receive payments for freelance work, sales, or services without exposing your primary holdings.',
  },
  {
    icon: Users,
    title: 'DAO Participation',
    description: 'Vote and participate in governance without revealing your total voting power or identity.',
  },
  {
    icon: Code,
    title: 'Testing & Development',
    description: 'Test dApps and smart contracts with isolated wallets. Keep dev activity separate from personal funds.',
  },
  {
    icon: Fingerprint,
    title: 'Identity Protection',
    description: 'Prevent wallet address from being tied to your real identity through transaction analysis.',
  },
  {
    icon: Building,
    title: 'Business Privacy',
    description: 'Receive business payments without exposing treasury or competitor intelligence.',
  },
];
    ...
    <section className="py-24 md:py-32 bg-card/30">
      <div className="section-container">
        ...
        <div className="hidden md:grid md:grid-cols-2 lg:grid-cols-3 gap-6 stagger-container">
          {useCases.map((useCase) => (
            <div key={useCase.title} className="feature-card stagger-item group">
