  ...
  <div className="relative w-48 h-32 md:w-64 md:h-40 perspective-1000 mx-auto">
    ...
    >
      ...
      <div className="p-5 flex flex-col justify-between h-full relative z-10">
        ...
        <div>
           <div className="text-[10px] uppercase tracking-widest text-white/40 mb-1">Disposable ID</div>
...
export const SolutionSection = () => {
  return (
    <section id="solution" className="py-24 md:py-32 relative overflow-hidden bg-[#030303]">
      {/* Ambient Background */}
      ...
      <div className="section-container relative z-10">
        ...
        <div className="text-center max-w-2xl mx-auto mb-20">
          ...
          <h2 className="text-4xl md:text-5xl font-bold mb-6 font-display tracking-tight text-white">
            Privacy in a <span className="bg-clip-text text-transparent bg-gradient-to-r from-primary via-purple-400 to-blue-400">Masterpiece</span>
          </h2>
          <p className="text-zinc-400 text-lg leading-relaxed">
            Every interaction is designed to be as fluid as it is secure. 
            Experience the future of anonymity.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 lg:grid-rows-2 gap-4 h-auto lg:h-[600px]">
          ...
          <div className="group lg:col-span-2 lg:row-span-2 rounded-3xl bg-zinc-900/40 border border-white/5 p-8 flex flex-col justify-between relative overflow-hidden backdrop-blur-sm hover:bg-zinc-900/60 transition-colors">
            ...
            <div className="relative z-10">
              <div className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center mb-4">
                 <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-primary"><rect width="20" height="14" x="2" y="5" rx="2"/><line x1="2" x2="22" y1="10" y2="10"/></svg>
              </div>
              <h3 className="text-xl font-bold text-white mb-2">Instant Identities</h3>
              <p className="text-zinc-400 text-sm leading-relaxed">
                Create disposable wallets in milliseconds. Use them for a single transaction or a whole session.
              </p>
            </div>
          ...
          <div className="lg:col-span-1 lg:row-span-1 rounded-3xl bg-zinc-900/40 border border-white/5 p-6 flex flex-col justify-between hover:border-primary/30 transition-colors group">
             ...
             <div>
                <h4 className="font-bold text-white text-sm mb-1">Non-Custodial</h4>
           ...
           <div className="lg:col-span-2 lg:row-span-1 rounded-3xl bg-zinc-900/40 border border-white/5 p-6 flex items-center justify-between hover:bg-zinc-900/60 transition-colors group overflow-hidden relative">
             <div className="relative z-10">
                <div className="w-10 h-10 rounded-full bg-purple-500/10 flex items-center justify-center text-purple-400 mb-4 group-hover:scale-110 transition-transform">
                   <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><path d="M2 12h20"/></svg>
                </div>
                <h4 className="font-bold text-white text-base">Protocol Agnostic</h4>
                <p className="text-xs text-zinc-500 mt-1 max-w-[150px]">Ready for the multi-chain privacy future.</p>
             </div>
             {/* Abstract Decor */}
             <div className="absolute right-0 top-0 h-full w-1/2 opacity-20">
                <svg className="h-full w-full" viewBox="0 0 100 100" preserveAspectRatio="none">
                   <path d="M0,100 C20,50 50,0 100,0 L100,100 Z" fill="url(#gradient-abstract)" />
                   <defs>
                      <linearGradient id="gradient-abstract" x1="0" y1="1" x2="1" y2="0">
